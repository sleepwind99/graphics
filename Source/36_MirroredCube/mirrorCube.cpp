// 36_MirroredCube
//    no interaction
//    detailed description: Modern OpenGL (fixed pipeline free) examples based on http://open.gl
//    source from https://github.com/zuck/opengl-examples
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Mirrored Cube", NULL, NULL);
