...
float speed1 = glm::radians(90.0f);  // 90 degrees/sec for the first rectangle
float speed2 = glm::radians(45.0f);  // 45 degrees/sec for the second rectangle
...
void render()
{
    ...
    transform = glm::scale(transform, glm::vec3(0.3f, 0.5f, 1.0f));
